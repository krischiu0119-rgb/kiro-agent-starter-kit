---
# 2026-05-05
description: Rules for executing code safely — always use files, never complex inline commands.
inclusion: auto
---
...
```
[TEMP_DIR]/
├── 20260501-test-api-response.py
├── 20260502-migrate-users.mjs
├── 20260503-benchmark.ts
├── 20260504-schema-check.sql
└── 20260505-data-export.py
```
...
- **Naming convention**: Adjust the date format or add category prefixes if needed (e.g., `YYYYMMDD-migration-description.sql`)
